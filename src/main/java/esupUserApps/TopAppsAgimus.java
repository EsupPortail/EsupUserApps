...
//  # the real rewriting
// RewriteRule ^/topApps/NONE/NONE/(\w+),([\w|-]+)$     http://localhost:9200/logstash-ent-pro-*/_search?source={"query":{"bool":{"filter":[{"exists":{"field":"external_people_domain"}},{"range":{"@timestamp":{"gte":"$2-$1","lte":"$2"}}}]}},"aggs":{"Services":{"terms":{"field":"service","size":25,"order":{"Sessions":"desc"}},"aggs":{"Sessions":{"cardinality":{"field":"global_session_id"}}}}},"size":0}&source_content_type=application/json [P]
// RewriteRule ^/topApps/([",\w-]*)/NONE/(\w+),([\w|-]+)$   http://localhost:9200/logstash-ent-pro-*/_search?source={"query":{"bool":{"filter":[{"terms":{"eduPersonAffiliation":[$1]}},{"range":{"@timestamp":{"gte":"$3-$2","lte":"$3"}}}]}},"aggs":{"Services":{"terms":{"field":"service","size":25,"order":{"Sessions":"desc"}},"aggs":{"Sessions":{"cardinality":{"field":"global_session_id"}}}}},"size":0}&source_content_type=application/json [P]
// RewriteRule ^/topApps/([",\w-]*)/([^/]*)/(\w+),([\w|-]+)$ http://localhost:9200/logstash-ent-pro-*/_search?source={"query":{"bool":{"filter":[{"terms":{"eduPersonAffiliation":[$1]}},{"terms":{"supannEntiteAffectation":[$2]}},{"range":{"@timestamp":{"gte":"$4-$3","lte":"$4"}}}]}},"aggs":{"Services":{"terms":{"field":"service","size":25,"order":{"Sessions":"desc"}},"aggs":{"Sessions":{"cardinality":{"field":"global_session_id"}}}}},"size":0}&source_content_type=application/json [P]
//
